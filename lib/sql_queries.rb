...
"SELECT projects.title as title, (SUM(pledges.amount)-projects.funding_goal) as over_goal FROM projects JOIN pledges ON projects.id = pledges.project_id WHERE over_goal >= 0 ORDER BY projects.title;"
end
