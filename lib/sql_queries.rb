...
"SELECT projects.title, SUM(pledges.amount)-projects.funding_goal FROM projects JOIN pledges ON projects.id = pledges.project_id WHERE SUM(pledges.amount)-projects.funding_goal > 0 GROUP BY projects.title;"
end
